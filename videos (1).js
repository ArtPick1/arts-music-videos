...
window.VIDEOS = [
{
  id: "king-with-no-crown-2025-10-06",
  title: "King With No Crown (The only way out)",
  youtubeId: "q3yWdE0i5_k",
  published: "2025-10-06T12:00:00-05:00",
  tags: ["Soulful", "Blues Rock", "Christian", "Repentance"],
  message: `<h2>King With No Crown (The only way out)</h2>
<p><strong>Genres:</strong> Soulful, Blues-Rock, Christian, Repentance</p>

<p><em>King With No Crown (The only way out)</em> is a soulful Christian blues-rock song about pride, repentance, and the hope found at the rugged cross.</p>
...
<p>This song is a call to repentance, surrender, and new life:</p>
<ul>
<li>➡️ Die to self</li>
<li>➡️ Be born again</li>
<li>➡️ Follow the One who is faithful</li>
</ul>
...
<p><em>It's made me break out the harmonica and try to learn it one more time.</em></p>`
},
{
